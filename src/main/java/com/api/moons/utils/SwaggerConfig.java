...
public class SwaggerConfig {
		...
		private final static String  TITLE = "Moons System API";
		private final static String  DESCRIPTION = "API de mapeamento de satelites naturais";
		...
		@Bean
		public OpenAPI OpenDocumentation() {
			return new OpenAPI()
